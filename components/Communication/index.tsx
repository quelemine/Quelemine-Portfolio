...
export default function Communication() {
  ...
  return (
    <section id="communication" className="section-padding relative" ref={ref}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="text-blue-400 text-sm font-semibold tracking-widest uppercase mb-3 block">Soft Skills</span>
          <h2 className="text-3xl sm:text-4xl font-bold text-white section-title">Communication Skills</h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {skills.map((skill, i) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className="glass-card rounded-2xl p-5 hover:border-blue-500/30 transition-all duration-300 group text-center"
            >
