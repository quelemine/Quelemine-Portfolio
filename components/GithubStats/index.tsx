...
const stats = [
  { icon: Code2, label: "Repositories", value: "20+", color: "text-blue-400", bg: "bg-blue-500/10" },
  { icon: Star, label: "Stars Earned", value: "10+", color: "text-yellow-400", bg: "bg-yellow-500/10" },
  { icon: GitFork, label: "Forks", value: "5+", color: "text-teal-400", bg: "bg-teal-500/10" },
  { icon: Activity, label: "Contributions", value: "100+", color: "text-purple-400", bg: "bg-purple-500/10" },
];
...
const techBadges = [
  ...
  { name: "React.js", color: "bg-blue-500/10 text-blue-400 border-blue-500/20" },
  { name: "PHP", color: "bg-indigo-500/10 text-indigo-400 border-indigo-500/20" },
  { name: "MySQL", color: "bg-teal-500/10 text-teal-400 border-teal-500/20" },
  { name: "JavaScript", color: "bg-yellow-500/10 text-yellow-400 border-yellow-500/20" },
  { name: "HTML5", color: "bg-red-500/10 text-red-400 border-red-500/20" },
  { name: "CSS3", color: "bg-blue-600/10 text-blue-300 border-blue-600/20" },
  { name: "Git", color: "bg-orange-600/10 text-orange-300 border-orange-600/20" },
  { name: "Linux", color: "bg-slate-500/10 text-slate-300 border-slate-500/20" },
];
  ...
  return (
    <section id="github" className="section-padding relative" ref={ref}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="text-blue-400 text-sm font-semibold tracking-widest uppercase mb-3 block">Open Source</span>
          <h2 className="text-3xl sm:text-4xl font-bold text-white section-title">GitHub Statistics</h2>
        </motion.div>
        ...
        >
          <h3 className="text-white font-semibold text-sm mb-4 text-center">Technology Badges</h3>
        ...
        <a
            ...
            className="btn-outline inline-flex items-center gap-2 px-6 py-3 rounded-xl text-slate-300 font-medium"
          >
            <FaGithub size={18} />
            View GitHub Profile
